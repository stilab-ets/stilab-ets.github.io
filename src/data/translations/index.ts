...
import {
  QuickLinksTranslations,
  quickLinksTranslations,
} from './quickLinks.translate';
import {
  ResearchAreasTranslations,
  researchAreasTranslations,
} from './researchAreas.translate';
...
import {
  ...
  publicationsTranslations,
} from './publications.translate';
import {
  ResearchTranslations,
  researchTranslations,
} from './research.translate';
import {
  TeachingTranslations,
  teachingTranslations,
} from './teaching.translate';
import {
  ProjectsTranslations,
  projectsTranslations,
} from './projects.translate';
import {
  VacanciesTranslations,
  vacanciesTranslations,
} from './vacancies.translate';
import { authTranslations, AuthTranslations } from './auth.translate';
import {
  dashboardTranslations,
  DashboardTranslations,
} from './dashboard.translate';
import { formsTranslations, FormsTranslations } from './forms';
import {
  adminInvitationManagementTranslations,
  AdminInvitationManagementTranslations,
} from './adminInvitationManagement.translate';
import {
  invitationsTranslations,
  InvitationsTranslations,
} from './invitations.translate';
