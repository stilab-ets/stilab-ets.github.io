...
export const researchTranslations: ResearchTranslationDict = {
  fr: {
    ...
    overview: {
      ...
      description:
        "Notre laboratoire de génie logiciel se concentre sur l'innovation et l'excellence dans le développement de solutions logicielles. Nos recherches couvrent un large spectre, de l'architecture des systèmes distribués à l'intelligence artificielle appliquée au développement logiciel.",
    ...
    domains: {
      softwareArchitecture: {
        ...
        description:
          "Conception et optimisation d'architectures logicielles scalables",
      },
      artificialIntelligence: {
        title: 'Intelligence Artificielle',
        description:
          "Application de l'IA aux processus de développement logiciel",
      },
      cybersecurity: {
        title: 'Cybersécurité',
        description:
          'Sécurité des systèmes distribués et applications blockchain',
      },
      devops: {
        title: 'DevOps',
        description:
          'Automatisation et optimisation des pipelines de développement',
      },
      cloudComputing: {
  ...
  en: {
    ...
    pageSubtitle:
      'Discover our research axes and innovative projects in software engineering',
    overview: {
      title: 'Overview',
      description:
        'Our software engineering laboratory focuses on innovation and excellence in developing software solutions. Our research covers a broad spectrum, from distributed system architectures to artificial intelligence applied to software development.',
    ...
    domains: {
      softwareArchitecture: {
        ...
        description:
          'Design and optimization of scalable software architectures',
      },
      artificialIntelligence: {
