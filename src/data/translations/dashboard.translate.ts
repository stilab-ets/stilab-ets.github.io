  ...
  en: {
    ...
    student: {
      ...
      courses: {
        ...
        description:
          'Course information will be displayed here when available.',
      },
      events: {
  ...
  fr: {
    ...
    errors: {
      ...
      accessRestricted: {
        ...
        description:
          "Votre compte n'a pas la permission d'accéder au tableau de bord.",
      },
    },
    admin: {
    ...
    professor: {
      ...
      teaching: {
        ...
        description:
          "Commencez par ajouter votre premier cours ou activité d'enseignement.",
      },
      profile: {
    ...
    student: {
      ...
      courses: {
        ...
        description:
          "Les informations sur les cours seront affichées ici lorsqu'elles seront disponibles.",
      },
      events: {
