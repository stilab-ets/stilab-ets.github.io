...
const isAuthenticated = computed(() => authMiddleware.state.isAuthenticated.value)
...
const validateForm = () => {
  ...
  if (!isAuthenticated.value) {
    errors.value.general = 'Authentication required. Please login first.'
    return false
  }
  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto p-6">
      <Card variant="elevated" padding="lg">
        ...
        <div v-if="!isAuthenticated" class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm text-yellow-700">
                You must be logged in to submit a publication.
                <button @click="redirectToLogin" class="font-medium underline hover:text-yellow-600">
                  Login here
                </button>
              </p>
            </div>
        ...
        <!-- Error Messages -->
        <div v-if="errors.general || error" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div class="flex items-center">
            <div class="flex-shrink-0">
            ...
            <div class="ml-3">
              <p class="text-sm text-red-700">{{ errors.general || error }}</p>
            </div>
          </div>
        </div>

        <!-- BibTeX Import Section -->
        <div v-if="isAuthenticated" class="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <!-- Publication Form -->
        <form v-if="isAuthenticated" @submit.prevent="submitForm" class="space-y-6">
          <!-- Entry Type (required) -->
          <div>
