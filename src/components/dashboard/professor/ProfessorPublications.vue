...
<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h2 class="text-xl font-semibold text-gray-900">{{ t.dashboard.professor.publications.title }}</h2>
      <Button>
          ...
          >
            ...
            <div class="flex justify-between items-center mt-2">
              <span :class="[
                ...
                {{ t.dashboard.professor.publications.status[publication.status as keyof typeof t.dashboard.professor.publications.status] }}
              </span>
