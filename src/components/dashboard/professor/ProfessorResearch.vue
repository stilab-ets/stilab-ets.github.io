  ...
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h2 class="text-xl font-semibold text-gray-900">
        {{ t.dashboard.professor.research.title }}
      </h2>
      <Button>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <div class="flex justify-between items-center mt-2">
              ...
              >
                {{
                  t.dashboard.professor.research.status[
                    project.status as keyof typeof t.dashboard.professor.research.status
                  ]
                }}
              </span>
              <span class="text-sm text-gray-500"
                >{{ t.dashboard.professor.research.due }}:
