...
const roleOptions = computed(() => [
  ...
  {
    value: 'professor',
    label: t.value.dashboard.admin.users.filters.professor,
  },
  {
    value: 'researcher',
    label: t.value.dashboard.admin.users.filters.researcher,
  },
...
const filteredUsers = computed(() => {
  ...
  if (selectedRole.value !== 'all') {
    filtered = filtered.filter(
      (user: { role: string }) => user.role === selectedRole.value
    );
  }
      ...
      <Card class="p-4">
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500">
            {{ t.dashboard.admin.users.stats.totalUsers }}
          </div>
        </div>
      </Card>
      <Card class="p-4">
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500">
            {{ t.dashboard.admin.users.stats.activeUsers }}
          </div>
        </div>
      </Card>
      <Card class="p-4">
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500">
            {{ t.dashboard.admin.users.stats.adminUsers }}
          </div>
        </div>
      </Card>
      <Card class="p-4">
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500">
            {{ t.dashboard.admin.users.stats.newThisWeek }}
          </div>
        </div>
      </Card>
    </div>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                >
                  {{
                    t.dashboard.admin.users.roles[
                      user.role as keyof typeof t.dashboard.admin.users.roles
                    ]
                  }}
                </span>
              </td>
