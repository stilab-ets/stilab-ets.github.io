...
const validateForm = () => {
  ...
  if (!formData.value.supervisor) {
    errors.value.supervisor = t.value.forms.vacancy.validation.supervisorRequired
  }
  ...
  if (!formData.value.description.trim()) {
    errors.value.description = t.value.forms.vacancy.validation.descriptionRequired
  }
  ...
  <div class="max-w-4xl mx-auto p-6">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              ...
              <option value="postdoc">{{ t.forms.vacancy.types.postdoc }}</option>
              <option value="researcher">{{ t.forms.vacancy.types.researcher }}</option>
              <option value="engineer">{{ t.forms.vacancy.types.engineer }}</option>
          ...
          <div>
            ...
            >
              <option value="">{{ t.forms.vacancy.form.selectSupervisor }}</option>
              <option v-for="supervisor in mockSupervisors" :key="supervisor.id" :value="supervisor.id">
                {{ supervisor.name }}
              </option>
            </select>
          ...
          <div class="md:col-span-2">
            ...
            >
              ...
              <option value="software-architecture">{{ t.forms.vacancy.domains.softwareArchitecture }}</option>
              <option value="artificial-intelligence">{{ t.forms.vacancy.domains.artificialIntelligence }}</option>
              <option value="cybersecurity">{{ t.forms.vacancy.domains.cybersecurity }}</option>
              <option value="devops">{{ t.forms.vacancy.domains.devops }}</option>
              <option value="cloud-computing">{{ t.forms.vacancy.domains.cloudComputing }}</option>
              <option value="software-testing">{{ t.forms.vacancy.domains.softwareTesting }}</option>
              <option value="distributed-systems">{{ t.forms.vacancy.domains.distributedSystems }}</option>
              <option value="blockchain">{{ t.forms.vacancy.domains.blockchain }}</option>
            </select>
      ...
      <Card>
        ...
        <!-- Tags -->
        <div class="mt-6">
          <label for="newTag" class="block text-sm font-medium text-gray-700 mb-2">
