...
<template>
  <Card variant="hover">
    ...
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
      <div class="flex-1">
        <div class="flex items-center mb-2">
          ...
          <span :class="[
            ...
            {{ isDeadlineSoon(vacancy.deadline) ? t.vacancies.vacancyCard.urgent : t.vacancies.vacancyCard.standard }}
          </span>
        </div>
        ...
        <div class="flex flex-wrap items-center text-sm text-gray-600 space-x-4 mb-3">
          <div class="flex items-center">
            ...
            <span class="font-medium">{{ t.vacancies.vacancyCard.supervisor }}:</span>
      ...
      <div class="flex flex-col text-sm text-gray-600 lg:text-right lg:ml-6">
        <div class="flex items-center lg:justify-end mb-1">
          ...
          <span class="font-medium">{{ t.vacancies.vacancyCard.deadline }}:</span>
    ...
    <!-- Requirements -->
    <div class="mb-4">
      <h4 class="text-sm font-medium text-gray-700 mb-2">{{ t.vacancies.vacancyCard.profile }}</h4>
