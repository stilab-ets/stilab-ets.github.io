...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div :class="[backgroundClass, 'rounded-lg p-8 mb-8']" v-if="backgroundClass !== 'bg-white'">
      <h2 v-if="title" class="text-2xl font-bold text-gray-900 mb-6 text-center">{{ title }}</h2>
