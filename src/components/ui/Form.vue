  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto p-6">
      <Card variant="elevated" padding="lg">
        ...
        <div v-if="requireAuth && !isAuthenticated && showLoginPrompt" 
          ...
          <div class="flex items-center">
            ...
            <div class="ml-3 text-sm text-yellow-700">
                ...
                <button @click="redirectToLogin" class="font-medium underline hover:text-yellow-600 hover:cursor-pointer">
                  {{ t.common.loginHere }}
                </button>
            </div>
          </div>
        ...
        <div v-if="successMessage" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm text-green-700">{{ t.common.successMessage }}</p>
            </div>
          </div>
        </div>
