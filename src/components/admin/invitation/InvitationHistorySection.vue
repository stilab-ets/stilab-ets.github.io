...
const t = computed(() => invitationsTranslations[currentLanguage.value].history)

const statuses = ['all', 'pending', 'registered', 'expired', 'canceled'] as const;
...
const filteredInvitations = computed(() => {
  ...
  return props.invitations.filter(invitation => invitation.status === filterStatus.value)
})
  ...
  <div class="space-y-6">
    ...
    <Card v-else-if="filteredInvitations.length === 0" class="p-8 text-center">
      <div class="w-12 h-12 mx-auto bg-gray-100 rounded-full flex items-center justify-center mb-4">
        <svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m0 0v5h12v-5m-12 0L8 9m8 4l4-4" />
        </svg>
      </div>
    ...
    <Card v-else class="overflow-hidden">
            ...
            <tr v-for="invitation in filteredInvitations" :key="invitation.id">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span :class="[
                  ...
                  {{ invitationsTranslations[currentLanguage].status[invitation.status] }}
                </span>
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                <span :class="{ 'text-red-600': isInvitationExpired(invitation.expiresAt) }">
      ...
      <div class="md:hidden space-y-4 p-4">
        <div v-for="invitation in filteredInvitations" :key="invitation.id" class="bg-gray-50 rounded-lg p-4">
          ...
          <div class="text-sm text-gray-600 space-y-1">
            ...
            <div :class="{ 'text-red-600': isInvitationExpired(invitation.expiresAt) }">
