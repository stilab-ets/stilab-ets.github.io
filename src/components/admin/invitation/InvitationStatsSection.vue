...
<template>
  <div class="space-y-6">
      ...
      <Card class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-900">{{ stats.registered || 0 }}</p>
            <div class="mt-1">
      ...
      <Card class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-900">{{ stats.expired || 0 }}</p>
            <div class="mt-1">
    ...
    <Card class="p-6" v-if="!isLoading && stats.total > 0">
      <h4 class="text-lg font-medium text-gray-900 mb-4">Invitation Distribution</h4>
      <div class="space-y-4">
        <!-- Pending progress -->
        <div>
