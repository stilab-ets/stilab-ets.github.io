...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">
      {{ t.research.researchAreas.title }}
    </h2>
    <div class="space-y-4">
      <div
        v-for="domain in researchAreas"
        :key="domain.id"
      ...
      >
        ...
        >
          ...
          <svg
            :class="[
              ...
              openAccordions.includes(domain.name)
        ...
        <!-- Accordion Content -->
        <div
          v-if="openAccordions.includes(domain.name)"
          class="px-6 pb-6 border-t border-gray-100"
        >
          <div class="mt-4">
            <h4 class="text-md font-medium text-gray-900 mb-3">
              {{ t.research.researchAreas.associatedProjects }}
            </h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p class="text-xs text-gray-500">
                  <strong>{{ t.research.featuredProjects.leader }}:</strong>
            ...
            <div
              v-if="getProjectsByDomain(domain.name).length === 0"
            ...
            >
              ...
              <p class="text-sm text-gray-500">
                {{ t.research.researchAreas.noActiveProjects }}
              </p>
            </div>
          </div>
        </div>
