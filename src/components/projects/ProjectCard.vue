...
const contactSupervisor = () => {
  const subject = encodeURIComponent(
    `Projet de Master: ${props.project.title}`
  );
  ...
  <Card variant="hover">
    ...
    >
      <div class="text-xs text-gray-500">
        {{ t.projects.projectCard.proposedOn }}
        {{ formatDate(project.proposed_date) }}
      </div>
