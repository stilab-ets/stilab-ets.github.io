...
<template>
  <div
    class="flex-1 w-full items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8"
  >
    <div class="max-w-lg w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            <label for="username_or_email" class="sr-only">{{
              t.form.email
            }}</label>
            <input
        ...
        <div>
          ...
          >
            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
              <Lock
                class="h-5 w-5 text-[#066a88] group-hover:text-[#044c5f]"
                aria-hidden="true"
              />
            </span>
