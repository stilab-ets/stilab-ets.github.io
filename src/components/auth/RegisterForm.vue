...
<template>
  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div
        v-if="tokenData"
        class="mt-4 bg-blue-50 border border-blue-200 rounded-md p-3"
      >
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-red-700">
                <p>
                  {{
                    accessError || 'You need a valid invitation to register.'
                  }}
                </p>
              </div>
            </div>
            ...
            :errors="
              validationErrors.filter(
                (error) =>
                  ...
                  error.includes('biography') ||
                  error.includes('rôle') ||
                  error.includes('domaine') ||
                  error.includes('biographie')
              )
            "
            :role-disabled="true"
          />
            ...
            :errors="
              validationErrors.filter(
                (error) =>
                  ...
                  error.includes('stackoverflow') ||
                  error.includes('twitterx') ||
                  error.includes('googlescholar') ||
                  error.includes('dblp')
              )
            "
          />
