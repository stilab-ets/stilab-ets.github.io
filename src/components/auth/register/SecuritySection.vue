    ...
    <div>
      ...
      <div class="mt-1 relative rounded-md shadow-sm">
        <input
          ...
          :class="{
            'border-red-500': errors.some(error => error.includes('password') || error.includes('mot de passe'))
          }"
        />
    ...
    <div>
      ...
      <div class="mt-1 relative rounded-md shadow-sm">
        <input
          ...
          class="block w-full pr-10 border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          :class="{
            'border-red-500': errors.some(error => error.includes('confirm') || error.includes('confirmer') || error.includes('match'))
          }"
        />
        <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
          <button
      ...
      <div class="flex space-x-1">
        <div
          ...
          :class="{
            ...
            'bg-yellow-400': modelValue.password.length >= 8 && modelValue.password.length < 12,
