...
<template>
  <section class="relative bg-gradient-to-br from-blue-50 via-white to-gray-50 py-20 sm:py-32">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div class="text-center lg:text-left">
            ...
            <!-- Research highlights -->
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center lg:text-left">
              <div class="flex flex-col items-center lg:items-start">
                <div class="w-12 h-12 bg-[#08a4d4] bg-opacity-10 rounded-lg flex items-center justify-center mb-3">
          ...
          <div class="relative">
            <div class="relative">
              ...
              <div class="absolute inset-0 bg-gradient-to-r from-[#08a4d4] to-blue-600 rounded-2xl transform rotate-3 opacity-10"></div>
              ...
              <div class="relative bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
                ...
                <div class="text-center mb-8">
                  ...
                  <p class="text-sm text-gray-600 mt-1">
                    {{ currentLanguage === 'fr' ? 'Laboratoire de Recherche' : 'Research Laboratory' }}
                  </p>
                </div>
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      <div class="absolute top-20 left-10 w-20 h-20 bg-[#08a4d4] bg-opacity-5 rounded-full opacity-20"></div>
      <div class="absolute bottom-20 right-10 w-32 h-32 bg-blue-500 bg-opacity-5 rounded-full opacity-30"></div>
      <div class="absolute top-3/4 left-1/5 w-128 h-128 z-10 bg-[#08a4d4] bg-opacity-5 rounded-full opacity-10"></div>
    </div>
  </section>
</template>