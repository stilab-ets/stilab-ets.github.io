    ...
    <form @submit.prevent="submitForm" class="space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          />
          <p v-if="errors.first_name" class="text-sm text-red-600">{{ errors.first_name }}</p>
        </div>
        <div>
          ...
          />
          <p v-if="errors.last_name" class="text-sm text-red-600">{{ errors.last_name }}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select v-model="formData.status" class="w-full p-3 border rounded-lg">
      ...
      <!-- Research + Bio -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Research Domain</label>
        <input
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input v-model="formData.image_url" type="url" class="w-full p-3 border rounded-lg" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">GitHub</label>
          <input v-model="formData.github_url" type="url" class="w-full p-3 border rounded-lg" />
        </div>
        <div>
