      ...
      <div class="mt-6 max-h-96 overflow-y-auto">
        ...
        <section class="mb-6">
          ...
          <div>
            ...
            <span v-else class="text-gray-400 italic">No research interests specified</span>
          </div>
        </section>
        ...
        <section class="mb-6">
          ...
          <div class="flex flex-wrap gap-3">
            ...
            >
              ...
              <svg class="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 100 100">
            ...
            >
              <!-- Twitter / X icon SVG -->
              <svg class="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 350 350">
            ...
            >
              <!-- Google Scholar SVG -->
              <svg class="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 512 512">
