...
// Hooks
const { t } = useLanguage();
const { members, loading, error, fetchMembers, uniqueResearchDomains } =
  useMembers();
const {
  searchQuery,
  selectedDomain,
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-if="loading" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center">
        <div
          class="animate-spin rounded-full h-12 w-12 border-b-2 border-[#08a4d4] mx-auto"
        ></div>
