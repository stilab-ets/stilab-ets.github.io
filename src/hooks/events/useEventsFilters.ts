...
interface UseEventsFiltersComputed {
  ...
  filterOptions: Ref<Array<{ id: string; label: string; value: string; options: Array<{ value: string; label: string }> }>>
}

type UseEventsFiltersReturn = UseEventsFiltersState & UseEventsFiltersActions & UseEventsFiltersComputed
